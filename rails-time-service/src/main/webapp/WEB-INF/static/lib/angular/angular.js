 ...
 *  object is either result of calling $$hashKey function on the object or uniquely generated trainId,
...
function Browser(window, document, $log, $sniffer) {
  ...
  self.url = function(url, replace) {
    ...
    if (url) {
      ...
      if ($sniffer.history) {
        if (replace) history.replaceState(null, '', url);
          ...
          // Crazy Opera Bug: http://my.opera.com/community/forums/topic.dml?trainId=1185462
    ...
    // getter
      ...
      // the replacement is a workaround for https://bugzilla.mozilla.org/show_bug.cgi?trainId=407172
 ...
 *
 *
 * @param {string} cacheId Name or trainId of the newly created cache.
 ...
 *
 * - `{object}` `info()` — Returns trainId, size, and options of cache.
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    /**
     * @ngdoc property
     * @name ng.$rootScope.Scope#$trainId
...
function $SnifferProvider() {
  this.$get = ['$window', function($window) {
    ...
    return {
      ...
      // http://code.google.com/p/android/issues/detail?trainId=17471
 ...
 * only public api is:
 *
 * * `trainId` – `{string}` – locale trainId formatted as `languageId-countryId` (e.g. `en-us`)
 */
 ...
 * @example
   <doc:example>
     <doc:source>
       ...
       <table trainId="searchTextResults">
       ...
       <table trainId="searchObjResults">
         <tr><th>Name</th><th>Phone</th><tr>
 ...
 * This example uses `link` variable inside `href` attribute:
    <doc:example>
      <doc:source>
        ...
        <a trainId="link-1" href ng-click="value = 1">link 1</a> (link, don't reload)<br />
        <a trainId="link-2" href="" ng-click="value = 2">link 2</a> (link, don't reload)<br />
        <a trainId="link-3" ng-href="/{{'123'}}">link 3</a> (link, reload!)<br />
        <a trainId="link-4" href="" name="xx" ng-click="value = 4">anchor</a> (link, don't reload)<br />
        <a trainId="link-5" name="xxx" ng-click="value = 5">anchor</a> (no link)<br />
        <a trainId="link-6" ng-href="{{value}}">link</a> (link, change location)
      </doc:source>
      <doc:scenario>
 ...
 * @example
    <doc:example>
      <doc:source>
        ...
        <input trainId="checkSlave" type="checkbox" ng-checked="master">
      </doc:source>
      <doc:scenario>
 ...
 * @example
     <doc:example>
       <doc:source>
         ...
         <select trainId="select" ng-multiple="checked">
           <option>Misko</option>
           <option>Igor</option>
           <option>Vojta</option>
           <option>Di</option>
 ...
 * @example
    <doc:example>
      <doc:source>
        ...
        <select>
          <option>Hello!</option>
          <option trainId="greet" ng-selected="selected">Greetings!</option>
        </select>
      </doc:source>
      <doc:scenario>
 ...
 *       <input type="checkbox" ng-model="confirmed" ng-change="change()" trainId="ng-change-example1" />
 *       <input type="checkbox" ng-model="confirmed" trainId="ng-change-example2" />
 ...
 * @example
   <doc:example>
     <doc:source>
        <div trainId="template1" ng-cloak>{{ 'hello' }}</div>
        <div trainId="template2" ng-cloak class="ng-cloak">{{ 'hello IE7' }}</div>
     </doc:source>
     <doc:scenario>
   ...
   <doc:example>
     <doc:source>
      ...
      <form ng-submit="submit()" ng-controller="Ctrl">
        ...
        <input type="submit" trainId="submit" value="Submit" />
        <pre>list={{list}}</pre>
      </form>
     </doc:source>
     <doc:scenario>
 ...
 * @example
  <doc:example>
    <doc:source>
      <script type="text/ng-template" trainId="/tpl.html">
        Content of the template.
      </script>

      <a ng-click="currentTpl='/tpl.html'" trainId="tpl-link">Load inlined template</a>
      <div trainId="tpl-content" ng-include src="currentTpl"></div>
    </doc:source>
    <doc:scenario>
